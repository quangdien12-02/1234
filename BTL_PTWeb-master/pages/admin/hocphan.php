...
<h4>Bảng số liệu các học phần</h4>
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="tool-content">
                    <li ><a class="fix-content" href="admin_dashboard.php?page=fix&mahocphan=<?php echo $row['mahocphan'] ?>">Sửa</a>
                    <li ><a class="delete-content" href="admin_dashboard.php?page=delete&mahocphan=<?php echo $row['mahocphan'] ?>">Xóa</a>
                </td>
            </tr>
            <?php }?>
            </tbody>
