...
$error = false;
    ...
    $sql = "INSERT INTO db_hocphan VALUES ('$mahocphan','$tenhocphan','$tinchi')";
    ...
    if($result){
        ...
        if ($success) {
            header("Location: admin_dashboard.php?page=hocphan&status1=Thêm học phần thành công!");
        } elseif ($error) {
            header("Location: admin_dashboard.php?page=hocphan&status2= Học phần vừa thêm đã có trong danh sách!");
            exit();
    }
    }
    ?>
...
<div class="list_tool">
    ...
    <div class="add_node">
    <li >
        <a href="admin_dashboard.php?page=add_hocphan">
